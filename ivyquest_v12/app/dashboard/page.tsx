...
const mockGamePlanData = {
  ...
  actions: [
    ...
    { id: '2', title: 'Schedule robotics workshop venue', description: 'Book community center for March workshop', category: 'activity', priority: 'high' as const, edgePoints: 30, timeEstimate: '1 hour' },
    { id: '3', title: 'Complete RSI application', description: 'Finish essays and gather recommendations', category: 'academic', priority: 'high' as const, edgePoints: 40, timeEstimate: '4 hours' },
  ],
};
...
export default function DashboardPage() {
  ...
  const { isComplete, profile } = useSessionStore();
