...
class TestIntentClassifier:
    ...
    def test_classify_essay_help(self):
        ...
        classifier = IntentClassifier()
        # Use phrasing that clearly matches the essay patterns
        intent, confidence = classifier.classify("I need help with my personal statement for college applications")
        
        assert intent == Intent.ESSAY_HELP
    
    def test_classify_essay_help_alternate(self):
        """Test classify detects essay help with different phrasing."""
        from reasoning.routing import IntentClassifier, Intent
        
        classifier = IntentClassifier()
        intent, confidence = classifier.classify("Can you help me write my common app essay?")
...
class TestAgentRouter:
    ...
    def test_route_essay_to_essay_agent(self):
        ...
        router = AgentRouter()
        # Use phrasing that clearly matches essay patterns
        decision = router.route("Help me with my personal statement and common app essay")
